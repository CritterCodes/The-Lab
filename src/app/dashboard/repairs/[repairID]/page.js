...
const ViewRepairPage = ({ params }) => {
    ...
    const [isWholesale, setIsWholesale] = React.useState(null);
    ...
    return (
        <Box sx={{ padding: { xs: '10px', sm: '20px' } }}>
            ...
            <Box sx={{ mt: 3, width: '100%' }}>
                <RepairTasksTable repairTasks={updatedRepair.repairTasks} onEdit={handleEditChange} isWholesale={isWholesale} selectedMetal={updatedRepair} />
            </Box>
            )}
